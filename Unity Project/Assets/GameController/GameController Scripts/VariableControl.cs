...
public class VariableControl : MonoBehaviour {
	...
	void Awake() {
		...
		phase1SelectedCharPositions[0] = new Vector3(-4.33f,-2.81f,0);
		phase1SelectedCharPositions[1] = new Vector3(4.33f,-2.81f,0);
		...
		characterTasteSpots[0] = new Vector3 (-1.9f,1.25f,-1f);
		characterTasteSpots[1] = new Vector3 (0.4f,1.25f,-1f);
	}
