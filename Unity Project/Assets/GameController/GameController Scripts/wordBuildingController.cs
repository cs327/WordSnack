...
public class wordBuildingController : MonoBehaviour
{
	...
	public bool secondAlert = false;
		...
		void Start ()
		{
                ...
                tasteHighLightPos [0] = new Vector3(1.0f, 0.0f, 0.08f);         // (-7.6f, 4.6f, -0.5f);
				tasteHighlighters [1] = char1Taste2;
        tasteHighLightPos [1] = new Vector3 (1.0f, 0.0f, 0.08f);          //(-7.6f, 3.9f, -0.5f);
				tasteHighlighters [2] = char2Taste1;
        tasteHighLightPos [2] = new Vector3 (-1.0f, 0.0f, 0.08f); //(7.6f, 4.6f, -0.5f);
				tasteHighlighters [3] = char2Taste2;
        tasteHighLightPos [3] = new Vector3 (-1.0f, 0.0f, 0.08f); //(7.6f, 3.9f, -0.5f);
